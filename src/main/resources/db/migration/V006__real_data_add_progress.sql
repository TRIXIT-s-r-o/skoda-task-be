...
values ('ECO Driving',
        ...
        1, 'https://gitlab.megumethod.dev/megumethod/skoda-auto/tender/icons/-/raw/main/icons/png/Leaf--Streamline-Sharp.png?ref_type=heads&inline=false', 0, 'AVAILABLE', 1),
       ('Regular Maintenance',
        ...
        1, 'https://gitlab.megumethod.dev/megumethod/skoda-auto/tender/icons/-/raw/main/icons/png/Wrench--Streamline-Sharp.png?ref_type=heads&inline=false', 0.25, 'AVAILABLE', 2),
       ('Decent driver',
        ...
        1, 'https://gitlab.megumethod.dev/megumethod/skoda-auto/tender/icons/-/raw/main/icons/png/Traffic-Light--Streamline-Sharp.png?ref_type=heads&inline=false', 0.33, 'AVAILABLE', 3),
       ('Remote access master',
        ...
        1, 'https://gitlab.megumethod.dev/megumethod/skoda-auto/tender/icons/-/raw/main/icons/png/Rss-Symbol--Streamline-Sharp.png?ref_type=heads&inline=false', 0.5, 'AVAILABLE', 1),
       ('Observing a Safe Distance',
        ...
        1, 'https://gitlab.megumethod.dev/megumethod/skoda-auto/tender/icons/-/raw/main/icons/png/Arrow-Diagonal-2--Streamline-Sharp.png', 0.66, 'AVAILABLE', 2),
       ('Škoda Loyalty',
        ...
        1, 'https://gitlab.megumethod.dev/megumethod/skoda-auto/tender/icons/-/raw/main/icons/png/Health-Care-2--Streamline-Sharp.png?ref_type=heads&inline=false', 0.75, 'AVAILABLE', 3);
